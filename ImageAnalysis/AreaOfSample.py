...
waitime = 50 # time in ms to wait before reading data from camera.
...
def ProcessImage():
    ...
    # Pauses for certain period of time (in milliseconds) before reading the data from the camera and storing it in the "img" array. Defined on line 11
    cv2.waitKey(waitime)
